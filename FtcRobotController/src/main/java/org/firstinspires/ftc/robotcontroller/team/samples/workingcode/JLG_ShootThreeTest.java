...
//     */
//    private final Pose startPose = new Pose(0, 0, Math.toRadians(90)); // Start position
//    private final Pose firstShotPose = new Pose(0, 40, Math.toRadians(90)); // Pose for First Group of Shots
//
//
//    //PATHS GO HERE.  USE DESCRIPTIVE NAMES.
//    private PathChain firstShotPath;
//
//
...
//    private AutoState autoState = AutoState.SHOOT1;
...
//                break;
//
//            case SHOOT2:  //Shoot three after movement, then turn on Intakes
//
//                    shootThree();
//
//                if (shooterState == ShooterState.END) {
